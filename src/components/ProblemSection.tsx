...
const problems = [
  ...
  },
  {
    ...
    description: "Product managers spend 80% of their time managing backlogs and writing specs instead of understanding what customers actually need.",
  },
  {
    icon: AlertTriangle,
    title: "Gut instinct doesn't scale",
    description: "When every feature costs nearly nothing to build, the cost of building the wrong feature becomes the only thing that matters.",
  },
];
  ...
  return (
    <section id="problem" className="relative py-24 md:py-32">
      <div className="container">
        ...
        >
          <span className="text-xs font-mono font-medium text-primary uppercase tracking-widest mb-4 block">The Problem</span>
          <h2 className="text-3xl md:text-5xl font-black mb-6">
            The bottleneck has{" "}
            <span className="text-gradient-primary">shifted</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            In the post-Cursor era, code writes itself. The new competitive advantage is knowing exactly what to build.
          </p>
        </motion.div>
