    ...
    <section id="workflow" className="relative py-24 md:py-32">
      ...
      <div className="container relative z-10">
        <motion.div
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">TrueNorth replaces fragmented tools with one continuous pipeline from raw customer signal to agent-ready spec.
